...
class Groundwater:
    ...
    def get_bohrkaster_info_df(self, station_nr: str)->pd.DataFrame:
        ...
        """
        try:
            info = self.bohr_kataster_df[self.bohr_kataster_df['catnum45'] == station_nr]
    ...
    def get_plot_waterlevels_df(self, station_nr: str, year_range: list)->pd.DataFrame:
        """
    ...
    def get_precipitation_chart(self, data_df: pd.DataFrame, settings: dict) -> alt.Chart:
        """
